...
const __attribute__((section (".firmware_versionH"))) unsigned long  	FirmwareVersionH = 0x00030004;
const __attribute__((section (".firmware_versionL"))) unsigned long  	FirmwareVersionL = 0x00030000;
