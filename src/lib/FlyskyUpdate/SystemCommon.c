...
const __attribute__((section (".firmware_versionH"))) unsigned long  	FirmwareVersionH = 0x00030006;
const __attribute__((section (".firmware_versionL"))) unsigned long  	FirmwareVersionL = 0x00040000;
